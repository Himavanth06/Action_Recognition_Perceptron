<b>Human Action Recognition using Perceptron Neural Network<b/>

This project implements a Human Action Recognition System using a Perceptron Neural Network.
The model is trained on labeled human action images and classifies an input image into actions such as walking, running, sitting, and standing.
